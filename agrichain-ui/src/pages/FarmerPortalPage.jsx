...
  // Redirection function: Simulates success and redirects to Dashboard
  const redirectToDashboard = () => {
    console.log("Authentication successful. Redirecting to Dashboard.");
    // Setting the hash immediately performs the client-side navigation
...
      // FIX: Call redirectToDashboard() directly (simulated success)
      redirectToDashboard(); 
